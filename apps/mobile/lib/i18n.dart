class I18n {
  ...
  String get tagline => t('Park like you belong here.', 'যেখানে জায়গা, সেখানেই পার্ক।');
  String get continuePhone => t('Continue with phone', 'ফোন দিয়ে চালিয়ে যান');
  ...
  String get wallet => t('Wallet', 'ওয়ালেট');
  String get profile => t('Profile', 'প্রোফাইল');
  String get renter => t('Renter', 'ভাড়াটিয়া');
