...
class _NotificationsPageState extends State<NotificationsPage> {
  ...
  Widget build(BuildContext context) {
    final i = I18n(session.bn);
    return Scaffold(
      appBar: AppBar(title: Text(i.t('Notifications', 'বিজ্ঞপ্তি'))),
      body: loading
          ? const Center(child: CircularProgressIndicator(color: Pb.yellow))
          : items.isEmpty
              ? Center(child: Text(i.t('No notifications yet.', 'কোনো বিজ্ঞপ্তি নেই।')))
              : ListView.builder(
                    ...
                    return Card(
                      ...
                      child: ListTile(
                        leading: const CircleAvatar(
                          ...
                          child: Icon(Icons.notifications, color: Pb.ink),
                        ),
